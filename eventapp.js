...
let comments = [
  ...
  "Second comment here.",
  "Another comment, just for testing purposes.",
...
function loadMoreComments() {
  // Simulated loading more comments
  // You can fetch more comments from a database or API here
  // For demonstration purposes, let's just add some more simulated comments
